function Sponsors()
{
    return <div className='homesabout'>
            <h2 style={{fontSize:'50px'}}>We thank our sponsors !</h2>
            ...
            Tristique et egestas quis ipsum suspendisse.
             Nisi lacus sed viverra tellus in hac habitasse platea dictumst. Eleifend quam adipiscing vitae proin.</p>
