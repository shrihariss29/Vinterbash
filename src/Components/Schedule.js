  ...
  return (
    <div>
      ...
      <div className="scheduleflex">
        {ScheduleCard('Music','Chordially Yours : group music','Finals','9:30 am to 11:30 am','To be announced','music.jpg')}
        ...
        {ScheduleCard('Art','Multi media madness','Finals','10:00 am to 01:00 pm','To be announced','art.jpg')}
        {ScheduleCard('English literature','"What if" Odyssey','Finals','10:00 am to 12 noon','To be announced','elits.jpg')}
        ...
        {ScheduleCard('Dance','Nalamdhaana','Prelims','11:30 am to 01:30 pm','To be announced','dance.jpg')}
        {ScheduleCard('Quiz',' Triquizzard tournament','Finals','11:30 am to 01:30 pm','To be announced','quiz.jpg')}
        {ScheduleCard('Dramatics','Aathi, idhu adhulla','Finals','11:30 am to 01:30 pm','To be announced','drama.jpg')}
        ...
        {ScheduleCard('Music','Acoustic Nirvana','Finals','2:00 pm to 4:00 pm','To be announced','music.jpg')}
        {ScheduleCard('Dance','Five,Six,Seven,Eight','Finals','02:00 pm to 02:30 pm','To be announced','dance.jpg')}
        ...
        {ScheduleCard('Art','Cartoon Universe Crossover','Prelims','02:00 pm to 05:00 pm','To be announced','art.jpg')}
